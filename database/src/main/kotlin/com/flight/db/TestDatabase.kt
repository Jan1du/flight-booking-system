...
object TestDatabase {
    ...
    fun create() {
        transaction(db) {
            SchemaUtils.drop(FlightTable, BookingTable, TicketTable, AirlineTable, AirportTable, UserTable)
            SchemaUtils.create(UserTable, BookingTable, TicketTable, AirlineTable, AirportTable, FlightTable)
